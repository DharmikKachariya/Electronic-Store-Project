      ...
      columns={[
        {
          ...
          field: "photoURL",
          render: (rowData) => (
            <img src={rowData.photoURL ? rowData.photoURL : Avatar} className="w-32 h-16 object-contain rounded-lg" />
          ),
        },
        {
          title: "Name",
        ...
        },
        {
          ...
          render: (rowData) => (
            <p
              className={`px-2 py-1 w-32 text-center text-primary rounded-lg ${
