...
const LoginInput = ({placeHolder, icon, inputState, inputStateFunc, type, isSignup}) => {
  ...
  return (
    <motion.div {...fadeInOut}
        className={`flex items-center justify-center gap-4 bg-[rgba(256,256,256,0.4)] backdrop-blur-md rounded-md w-full px-4 py-2 
            ${isFocus ? "shadow-md shadow-gray-400" : "shadow-none"
        }`}>
      {icon}
      <input 
        type={type} 
