...
const Home = () => {
    return ( <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
        <div className="flex flex-col items-start justify-start gap-6">
                ...
                <p className="text-lg font-semibold text-orange-600">Free Delivery</p>
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-primary shadow-lg">
                    <img
                      src={Delivery}
                      alt=""
            ...
            <p className="text-[35px] text-headingColor md:text-[72px] font-sans font-extrabold tracking-wider">
        ...
        <motion.button {...buttonClcik}  className="bg-gradient-to-bl from-blue-400 to-blue-600 px-4 py-2 rounded-xl text-black text-base font-semibold">
        Order Now
        </motion.button>
        </div>
            ...
            <img className="absolute top-0 right-0 md:right-3 w-full h-420 lg:w-auto md:h-650"
                src={HeroBg}
                alt=""
                />
            ...
            {randomData &&
                ...
                <motion.div
                    key={i}
                    {...staggerFadeInOut(i)}
                    className=" w-32 h-36 md:h-auto  md:w-190 p-4 bg-[rgba(256,256,256,0.4)]
